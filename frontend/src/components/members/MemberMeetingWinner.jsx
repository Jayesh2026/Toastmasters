...
import WinnersListModal from '../admin/WinnersListModal';

const MemberMeetingWinner = () => {
  ...
  const fetchMeetings = async () => {
    try {
      ...
      const now = new Date();
      const pastMeetings = (response?.data?.data || [])
  ...
  return (
    <div>
      <div className="mb-4">
        ...
        <p className="text-muted">View winners for past meetings</p>
      </div>
...
export default MemberMeetingWinner;
